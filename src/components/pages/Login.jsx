  ...
  return (
    <div>
      <div className="row login-div">
        <div className="col-xs-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3 col-xxl-4 offset-xxl-4">
              ...
              <div className="p-5 pt-0">
                <form className="">
                  <div className="form-floating mb-3">
                    <input
                      type="email"
                      className="form-control rounded-3 form-medio"
                      id="floatingInput"
                  ...
                  <div className="form-floating mb-1">
                    ...
                    />
                    <label htmlFor="floatingPassword">Digite a sua senha</label>
                  </div>
